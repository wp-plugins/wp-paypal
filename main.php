...
class WP_PAYPAL {
    ...
    function options_page() {
        ...
        echo '<div class="wrap">' . screen_icon() . '<h2>WP PayPal v' . WP_PAYPAL_VERSION . '</h2>';
    ...
    function general_settings() {
        ...
        <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
            ...
            <p class="submit"><input type="submit" name="wp_paypal_update_settings" id="wp_paypal_update_settings" class="button button-primary" value="Save Changes"></p></form>
            ...
            <div id="poststuff">
                <div id="post-body">
                    ...
                    <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
                        ...
                        <p class="submit"><input type="submit" name="wp_paypal_update_log_settings" id="wp_paypal_update_log_settings" class="button button-primary" value="Save Changes"></p>
                    </form>
                    <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
                        <?php wp_nonce_field('wp_paypal_reset_log_settings'); ?>                            
                        <p class="submit"><input type="submit" name="wp_paypal_reset_log" id="wp_paypal_reset_log" class="button" value="Reset Log"></p>
                    </form>
                </div>         
            </div>
        </div>
...
function wp_paypal_button_handler($atts) {
    ...
    $button_code = '<div>';
    $button_code .= '<script src="' . WP_PAYPAL_URL . '/lib/paypal-button.min.js?merchant=' . $paypal_email . '"';
